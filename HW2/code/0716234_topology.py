...
def config(hosts, switches, routers, DHCPServer):
    ...
    hosts['h3'].cmd('ifconfig h3-eth0 192.168.1.129/25')
    hosts['h4'].cmd('ifconfig h4-eth0 192.168.1.130/25')
    hosts['h5'].cmd('ifconfig h5-eth0 192.168.3.2/24')
    hosts['h6'].cmd('ifconfig h6-eth0 192.168.3.3/24')
    DHCPServer.cmd('ifconfig DHCPServer-eth0 192.168.1.4/25')

    routers['r1'].cmd('ifconfig r1-eth0 10.0.1.2/24')
    routers['r1'].cmd('ifconfig r1-eth1 192.168.1.126/25')
    routers['r1'].cmd('ifconfig r1-eth2 192.168.1.254/25')
    ...
    hosts['h3'].cmd('route add default gw 192.168.1.254')
    hosts['h4'].cmd('route add default gw 192.168.1.254')
